"use client";
/* Vendored from ReactBits — the exhaustive-deps refactor risks changing the
   gesture behaviour, so that one rule is disabled for this file only. */
/* eslint-disable react-hooks/exhaustive-deps, no-console, prefer-const */
