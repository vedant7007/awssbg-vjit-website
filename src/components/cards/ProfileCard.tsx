...
const DEFAULT_INNER_GRADIENT =
  "linear-gradient(145deg, rgba(27,34,51,0.9) 0%, rgba(255,153,0,0.05) 100%)";
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  avatarUrl = "/placeholder-avatar.jpg", // Safe fallback
  iconUrl,
  grainUrl,
  innerGradient,
  ...
  useEffect(() => {
    ...
    const deviceOrientationHandler =
      handleDeviceOrientation as unknown as EventListener;
          ...
          .then((state) => {
            if (state === "granted") {
              window.addEventListener(
                "deviceorientation",
                deviceOrientationHandler as unknown as EventListener,
              );
            }
          })
          .catch(() => {});
  ...
  >(
    () =>
      ({
        ...
        "--behind-glow-color": behindGlowColor ?? "rgba(255, 153, 0, 0.4)",
        ...
        <section className="pc-card">
          <div className="pc-inside">
            ...
            <div className="pc-content pc-avatar-content">
              {/* Added standard styling fallback and next-compatible image wrapper inside style or standard img */}
