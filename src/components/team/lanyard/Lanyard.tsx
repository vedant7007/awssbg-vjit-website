...
/**
 * Vendored from ReactBits. Only change from upstream: the GLB and lanyard
 * texture are served from /public instead of being bundled, since Next has no
 * loader for .glb imports.
 */
"use client";
...
interface LanyardProps {
  ...
  lanyardWidth?: number;
  /** World-space x/y of the rig's fixed point. */
